...
# path_gse35088 <- "/Users/selcukkorkmaz/Documents/Studies/AMI_miRNA/GSE35088_RAW"
# 
# # 
# # # untar files
# untar(paste0(path_gse35088, ".tar"), exdir = "/Users/selcukkorkmaz/Documents/Studies/AMI_miRNA/GSE35088/")
# 
# # Reading CEL files
# celFiles <- list.files("/Users/selcukkorkmaz/Documents/Studies/AMI_miRNA/GSE35088/")
# full_cel_paths <- paste0("/Users/selcukkorkmaz/Documents/Studies/AMI_miRNA/GSE35088/", celFiles)
...
# groups_df = read_excel("data/GSE35088_groups.xlsx")
...
groups = as.factor(c("Control","Control","Control", "Control","Control","Control","Control","Control", "MI","MI","MI","MI","MI","MI","MI","MI"))
...
write.table(gset_exp2, "data/GSE35088_expression.txt", quote = F, sep = "\t")
...
write.table(topGenes, file="data/TopGenes_GSE35088.txt", row.names=F, sep="\t", quote = F)
...
dim(degs_data)
degs_data
write.table(degs_data, file="data/DEGs_GSE35088.txt", row.names=F, sep="\t", quote = F)
...
layout <- plotDensities(ex, group=groups, main="GSE35088: Expression value distribution", legend ="topright")
...
ggsave('~/Documents/Studies/AMI_miRNA/Figures/boxplot.png', p2, width = 16, height = 8)


# p = p+ plot_annotation(tag_levels = 'A')

# ggsave('~/Documents/Studies/AMI_miRNA/Figures/GSE35088_RLE.png', p, width = 16, height = 8)
...
p_gse35088 <-  EnhancedVolcano::EnhancedVolcano(tT,
                       lab = NA,
                       x = 'logFC',
                       y = 'adj.P.Val',
                       xlim = c(-4,4),
...
# p = p+ plot_annotation(tag_levels = 'A')
# 
ggsave('~/Documents/Studies/AMI_miRNA/Figures/GSE35088_volcano_umap.png', p2, width = 12, height = 8)
# 
# 
# 
# 
